...
export default function ZoomControl({ isJa, stage, onSelect }: Props) {
  ...
  return (
    <button
      ...
      className={`w-11 h-11 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center hover:scale-105 active:scale-95 transition-all duration-200 border border-black/5 pointer-events-auto shadow-sm backdrop-blur-md ${FILL[stage]}`}
    >
