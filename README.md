...
- **カメラで巡るナビゲーション**: 惑星上の各建物が About / Products / Skills / Experience / Contact のアクセスポイント。建物の上に浮かぶ丸いマーカー（またはカードの「詳しく見る」）を押すとカメラがその建物へ飛び込み、詳細ページが開きます。スクロールすると全建物を通る軌道に沿ってカメラが進み、ドラッグで自由に見回せます。2本指ピンチ、またはヘッダーのズームボタン（押すたびに 俯瞰→標準→正面の建物 と巡回）で距離を切り替えられます。
