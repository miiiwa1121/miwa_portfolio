...
- **カメラで巡るナビゲーション**: 惑星上の各建物が About / Products / Skills / Experience / Contact のアクセスポイント。クリックするとカメラがその建物へスムーズに飛び込み、詳細ページが開きます。スクロールすると全建物を通る軌道に沿ってカメラが進み、長押し＋ドラッグで自由に見回せます。
...
- **読み終えて戻る自己紹介**: 自己紹介だけは詳細ページを持たず、テキストが街の上に直接乗ります。読み進めて一番下まで来ると、そのままホームの俯瞰へ戻ります。
- **多言語対応**: ヘッダーのトグルで日本語 / 英語を切り替えできます。
- **停止・再生**: 言語トグルの右のボタンで、街の動き（自動回転・観覧車・トラム・住人・星屑）を押した瞬間に止められます。止めている間も自分でドラッグして眺める角度は変えられ、再生すると止めたところから続きます。
