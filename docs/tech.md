...
- **黄（`#FFE81F`）には暗い `text-shadow` の縁取りを掛ける。** image9 は純黒の星空だがこちらは惑星が背後を通る——黄 on 惑星の緑はコントラスト比 **1.60** で読めない。縁取りなら星空の上では見えず、重なる区間だけ効く。
